    ...
    <div class="LoginBox-Box">
      ...
      <el-form-item prop="name">
       ...
       <el-form-item prop="password">
        <el-input prefix-icon="el-icon-lock" type="password" v-model="form.password" @keyup.enter.native="onSubmit"></el-input>
      </el-form-item>
      <el-form-item>
      ...
      <el-form-item>
        <div class="login_bottom">
          <el-button type="success" @click="Gohome">游客</el-button>        
  ...
  <div class="register"  v-else>
    <div class="registerBox">
      ...
      <el-form-item prop="regname">
        <el-input prefix-icon="el-icon-user" v-model="regform.regname"  placeholder="请输入用户名"></el-input>
      </el-form-item>
      <el-form-item prop="nickname">
        <el-input prefix-icon="el-icon-user" v-model="regform.nickname" placeholder="请输入昵称"></el-input>
      </el-form-item>
      <el-form-item  prop="pass">
        <el-input prefix-icon="el-icon-lock" type="password" placeholder="请输入密码" v-model="regform.pass" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item  prop="checkPass">
        <el-input prefix-icon="el-icon-lock" type="password" placeholder="请再次输入密码" v-model="regform.checkPass" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
